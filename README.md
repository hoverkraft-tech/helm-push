# Helm Push
![Build](https://github.com/hoverkraft-tech/helm-push/workflows/Build/badge.svg)
![GitHub last commit](https://img.shields.io/github/last-commit/hoverkraft-tech/helm-push.svg)
![License](https://img.shields.io/github/license/hoverkraft-tech/helm-push.svg?style=flat)
...
steps:
  - name: Push Helm chart to OCI compatible registry (Github)
    uses: hoverkraft-tech/helm-push@4.2.0
    with:
      useOCIRegistry: true
      registry-url:  oci://ghcr.io/${{ github.repository }}
      username: hoverkraft-tech
